<template>
  <section>
    ...
    <section>
      <Heading
        subHeaderName="Part 0: The Spark of Hope"
      />
    </section>
    <section class="about">
    ...
    <section>
      <Heading
        subHeaderName="Part 1: The Twelfth Moon of Uranus"
      />
<!--      <section class="about">-->
<!--        <p>Six hundred earth-solar cycles have passed since the Overthrow. Woael Rojhnston just left the familiar comfort of his appleFluidPodXS to project a disney onto his corporeal neuronetwork.</p>-->
<!--      </section>-->
    </section>
  </section>
